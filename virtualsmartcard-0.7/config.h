...
/* Define to 1 if you have the <qrencode.h> header file. */
#define HAVE_QRENCODE_H 1
...
#define PACKAGE_STRING "Virtual Smart Card 0.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "virtualsmartcard"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://frankmorgner.github.io/vsmartcard/virtualsmartcard/README.html"
